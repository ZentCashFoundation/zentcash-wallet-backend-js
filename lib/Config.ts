...
export interface IConfig {
     ...
     * In Zent Cash, this converts to ZTC
     */
...
export class Config implements IConfig {
     ...
     */
    public addressPrefix: number = 4419;
     ...
     * - 5 ZTC vs 5.12 ZTC. You can read this as.. the fee per chunk
     * is 500 atomic units. The fee per byte is 500 / chunk size. */
    public minimumFeePerByte = 26 / this.feePerByteChunkSize;
