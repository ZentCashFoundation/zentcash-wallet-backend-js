// Copyright (c) 2018-2023, Zent Cash
//
...
import { CreatedTransaction } from 'zentcash-utils';
...
export class WalletBackend extends EventEmitter {
     ...
     * as zent-service or zedwallet, and will be unable to open wallets
     ...
     * The password protection follows the same format as wallet-api,
     * zentwallet-beta, and WalletBackend. It does NOT follow the same format
     * as zent-service or zedwallet, and will be unable to open wallets
     * created with this program.
     *
     * Example:
     ...
     * the JSON to use, see https://github.com/ZentCashFoundation/wallet-file-interaction
     *
     ...
     * only wallet. For more information on subwallets, see https://docs.zent.cash/developer/subwallets
     *
     * Example:
     * ```javascript
     ...
     * on a non view wallet. For more information on subwallets, see https://docs.zent.cash/developer/subwallets
     *
     * Example:
     * ```javascript
